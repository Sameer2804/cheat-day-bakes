...
function goToCheckout() {
  setIsCheckoutBtnClicked(true);
  if(disableUpdateButton) {
    setIsGoToCheckout(true)
  }
}
                    ...
                    <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                      <div className="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
                        ...
                        <div className="mt-8">
                          ...
                          <DeleteDialog
                              open={isCheckoutBtnClicked && !disableUpdateButton} 
                              setOpen={setIsCheckoutBtnClicked} 
                              onDelete={() => setIsGoToCheckout(true)} 
                              title={'Unsaved changes'} 
                              text={'Proceeding to checkout now will discard your basket edits. Go to checkout without saving?'}
                              btnText="Proceed to checkout"
                            />
                            <ul role="list" className="-my-6 divide-y divide-gray-200 select-none">
                              ...
                              {cartProducts.length > 0 && cartProducts.map((product, index) => (
                                <li className="flex py-6">
                                  ...
                                  <div className="ml-4 flex flex-1 flex-col">
                                    ...
                                    <div className="flex flex-1 items-end justify-between text-sm mt-2.5">
                                      {product.quantity && (
                                          <div className='w-28'>
                                              <QuantityButton quantity={quantity[index]} isBig={false} setQuantity={(value) => setQuantityAtIndex(index, value)} />
                                          </div>
                                      )}
                      ...
                      <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                        ...
                        <div className="mt-3">
                            ...
                            type='button'
                              ...
                              className={`w-full rounded-md border border-transparent bg-primary px-6 py-3 text-base font-medium shadow-sm hover:bg-dark duration-300 ${cartProducts.length == 0 ? 'text-gray-500' : 'text-white'}`}
                            >
                              Checkout
                            </button>
                        </div>
